...
| Waves accuracy           | -                |  **±17.X cm/s**  | -                 |
| Compatibility            | Windows          | Windows          | Windows and macOS |

: Comparison of each Mini Buoy design. {#tbl-1}
...
![](figs/OperatingPrinciples.png){fig-align='centre'}
...
![](figs/QDA.png){fig-align='centre' width=70%}
...
![](figs/ASD.png){fig-align='centre' width=70%}
...
![](figs/CalibrationCurves.png){fig-align='centre' width=70%}
