...
::: {.callout-note}
The MSR software should automatically open an .msr file to view the data. If nothing happens, double-click `Viewer` and select `File`, `Open`, and select the .msr file.
...
![](figs/MSRExportStep7.png){fig-align='center' width=70%}
