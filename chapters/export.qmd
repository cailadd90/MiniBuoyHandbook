...
After a deployment, the data can be retrieved from the logger and exported as a .csv data table. It is important to save your data in the data format that can be recognised by the Mini Buoy App. Select the correct software tab according to the logger type being configured:
